...
#logging.basicConfig(filename='oven.log',level=logging.DEBUG)
### Server
...
### Outputs
gpio_heat = 15  # Switches zero-cross solid-state-relay
gpio_cool = 14  # Regulates PWM for 12V DC Blower
gpio_air  = 18   # Switches 0-phase det. solid-state-relay
...
max31855 = 1
max6675 = 0
### select this and unselet the two above if you use hardware SPI 0 on Raspberry Pi 2 B
max31855_hardware_spi = 0

### Thermocouple SPI Connection
gpio_sensor_cs = 17
gpio_sensor_clock = 27
gpio_sensor_data = 22
